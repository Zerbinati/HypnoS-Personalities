...
void MainThread::search() {
  ...
  Thread* bestThread = this;
    ...
    int calculationDepth   = Stockfish::Eval::activePersonality.get_evaluation_param("CalculationDepth", 0);
	...
	int humanImperfection  = Stockfish::Eval::activePersonality.get_evaluation_param("HumanImperfection", 0);
...
// Applying search depth to the evaluation with loss_streak bonus
  int depthBonus = (Stockfish::Eval::loss_streak > 5) ? std::min(Stockfish::Eval::loss_streak / 2, 3) : 0;  // Max +3 ply
